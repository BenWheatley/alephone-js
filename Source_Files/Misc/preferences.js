...
static void player_dialog(void *arg)
{
	...
	w_select *level_w = new w_select(player_preferences->difficulty_level, NULL); // null is level_labels?
...
const default_key_bindings = {
	0: [keyboard.SCANCODE_W, joystick.AO_SCANCODE_BASE_JOYSTICK_AXIS_NEGATIVE + keyboard.CONTROLLER_AXIS_LEFTY],
	1: [keyboard.SCANCODE_S, joystick.AO_SCANCODE_BASE_JOYSTICK_AXIS_POSITIVE + keyboard.CONTROLLER_AXIS_LEFTY],
	2: [keyboard.SCANCODE_LEFT, joystick.AO_SCANCODE_BASE_JOYSTICK_AXIS_NEGATIVE + keyboard.CONTROLLER_AXIS_RIGHTX],
	3: [keyboard.SCANCODE_RIGHT, joystick.AO_SCANCODE_BASE_JOYSTICK_AXIS_POSITIVE + keyboard.CONTROLLER_AXIS_RIGHTX],
	4: [keyboard.SCANCODE_A, joystick.AO_SCANCODE_BASE_JOYSTICK_AXIS_NEGATIVE + keyboard.CONTROLLER_AXIS_LEFTX],
	5: [keyboard.SCANCODE_D, joystick.AO_SCANCODE_BASE_JOYSTICK_AXIS_POSITIVE + keyboard.CONTROLLER_AXIS_LEFTX],
	6: [keyboard.SCANCODE_Q, joystick.AO_SCANCODE_BASE_JOYSTICK_BUTTON + keyboard.CONTROLLER_BUTTON_DPAD_LEFT],
	7: [keyboard.SCANCODE_E, joystick.AO_SCANCODE_BASE_JOYSTICK_BUTTON + keyboard.CONTROLLER_BUTTON_DPAD_RIGHT],
	8: [keyboard.SCANCODE_UP, joystick.AO_SCANCODE_BASE_JOYSTICK_AXIS_NEGATIVE + keyboard.CONTROLLER_AXIS_RIGHTY],
	9: [keyboard.SCANCODE_DOWN, joystick.AO_SCANCODE_BASE_JOYSTICK_AXIS_POSITIVE + keyboard.CONTROLLER_AXIS_RIGHTY],
	10: [keyboard.SCANCODE_V, joystick.AO_SCANCODE_BASE_JOYSTICK_BUTTON + keyboard.CONTROLLER_BUTTON_RIGHTSTICK],
	11: [keyboard.SCANCODE_F, mouse.AO_SCANCODE_MOUSESCROLL_UP, joystick.AO_SCANCODE_BASE_JOYSTICK_BUTTON + keyboard.CONTROLLER_BUTTON_LEFTSHOULDER],
	12: [keyboard.SCANCODE_R, mouse.AO_SCANCODE_MOUSESCROLL_DOWN, joystick.AO_SCANCODE_BASE_JOYSTICK_BUTTON + keyboard.CONTROLLER_BUTTON_RIGHTSHOULDER],
	13: [keyboard.SCANCODE_SPACE, mouse.AO_SCANCODE_BASE_MOUSE_BUTTON + keyboard.BUTTON_LEFT - 1, joystick.AO_SCANCODE_BASE_JOYSTICK_AXIS_POSITIVE + keyboard.CONTROLLER_AXIS_TRIGGERRIGHT],
	14: [keyboard.SCANCODE_LSHIFT, mouse.AO_SCANCODE_BASE_MOUSE_BUTTON + keyboard.BUTTON_RIGHT - 1, joystick.AO_SCANCODE_BASE_JOYSTICK_AXIS_POSITIVE + keyboard.CONTROLLER_AXIS_TRIGGERLEFT],
	15: [keyboard.SCANCODE_LALT],
	16: [keyboard.SCANCODE_LCTRL, joystick.AO_SCANCODE_BASE_JOYSTICK_BUTTON + keyboard.CONTROLLER_BUTTON_LEFTSTICK],
	17: [keyboard.SCANCODE_LGUI],
	18: [keyboard.SCANCODE_TAB, joystick.AO_SCANCODE_BASE_JOYSTICK_BUTTON + keyboard.CONTROLLER_BUTTON_A],
	19: [keyboard.SCANCODE_M, joystick.AO_SCANCODE_BASE_JOYSTICK_BUTTON + keyboard.CONTROLLER_BUTTON_X],
	20: [keyboard.SCANCODE_GRAVE, joystick.AO_SCANCODE_BASE_JOYSTICK_BUTTON + keyboard.CONTROLLER_BUTTON_Y]
};
...
const default_shell_key_bindings = {
	0: [keyboard.SCANCODE_LEFTBRACKET],
	1: [keyboard.SCANCODE_RIGHTBRACKET],
	2: [keyboard.SCANCODE_BACKSPACE],
	3: [keyboard.SCANCODE_PERIOD],
	4: [keyboard.SCANCODE_COMMA],
	5: [keyboard.SCANCODE_EQUALS, joystick.AO_SCANCODE_BASE_JOYSTICK_BUTTON + keyboard.CONTROLLER_BUTTON_DPAD_UP],
	6: [keyboard.SCANCODE_MINUS, joystick.AO_SCANCODE_BASE_JOYSTICK_BUTTON + keyboard.CONTROLLER_BUTTON_DPAD_DOWN],
	7: [keyboard.SCANCODE_SLASH],
	8: [keyboard.SCANCODE_BACKSLASH],
	9: [keyboard.SCANCODE_N]
};
...
const default_hotkey_bindings = {
	0: [keyboard.SCANCODE_1],
	1: [keyboard.SCANCODE_2],
	2: [keyboard.SCANCODE_3],
	3: [keyboard.SCANCODE_4],
	4: [keyboard.SCANCODE_5],
	5: [keyboard.SCANCODE_6],
	6: [keyboard.SCANCODE_7],
	7: [keyboard.SCANCODE_8],
	8: [keyboard.SCANCODE_9],
	9: [keyboard.SCANCODE_T],
	10: [keyboard.SCANCODE_G],
	11: [keyboard.SCANCODE_B]
};
/*
